<html>
    ...
    <style>
      * {
      ...
      @font-face {
        ...
        src: url("../fonts/NewsGothicBT-BoldExtraCondensed.otf")
          format("opentype");
      }
      @font-face {
        font-family: NewsGothicECM;
        src: url("../fonts/NewsGothicBT-ExtraCondensed.otf") format("opentype");
      }
      @font-face {
        font-family: NewsGothicRC;
        src: url("../fonts/NewsGothicBT-RomanCondensed.ttf") format("truetype");
      }
      ...
      .footer {
        background: url("../images/footer.png") #fff 100% 50% no-repeat;
        background-size: 20.1vw;
        position: absolute;
        bottom: 0;
        width: 100%;
        padding: 1.8vw 2.56vw;
        box-sizing: border-box;
        border-bottom: 10px solid #efbb3d;
        height: 9.26vw;
      }
      .footer .novartis {
        background: url("../images/novatris.png") 0% 50% no-repeat;
      ...
      @media screen and (aspect-ratio: 16/9) {
        ...
        .wrapper {
          background: url("../images/169/bg3.png") 0 0 no-repeat;
          background-size: contain;
          margin-bottom: -16.1vw;
        }
        .home .wrapper {
          background: url("../images/169/bg1.png") 0 0 no-repeat;
          background-size: cover;
        }
        .home2 .wrapper {
          background: url("../images/169/bg2.png") 0 0 no-repeat;
          background-size: contain;
        }
        .wrapper.qu,
        .wrapper.lb {
          background: url("../images/169/bg4.png") 0 0 no-repeat;
          background-size: cover;
        }
        .man {
          background: url("../images//169/man.png") 100% 0 no-repeat;
          background-size: cover;
          position: absolute;
          right: 0;
          z-index: 1;
  ...
  <body class="bc">
    <div class="wrapper pt149">
      <div class="container">
        <div class="coll">
          <span class="fs50 NewsGothicECB"
            >Terapie skojarzone zawierające ENTRESTO<sup>®</sup> w większym stopniu redukują ryzyko śmiertelności z jakiejkolwiek przyczyny u pacjentów z HFrEF<sup>1†</sup></span
          >
          <p class="fs45 NewsGothicECM">
            W metaanalizie obejmującej 75 badań i 95 444 pacjentów, kombinacje leków zawierające ENTRESTO® wiązały się z większym zmniejszeniem ryzyka śmiertelności z jakiejkolwiek przyczyny<sup>1†</sup>
          </p>
          <div>
            <div class="grid two">
              <div id="wBB" class="grid two">
                <span class="NewsGothicECB fs55 switchBB">BB</span>
                <div>
                  <input
                    type="checkbox"
                    id="switchBB"
                    onclick="labelChange('switchBB')"
                  /><label for="switchBB">BB</label>
                </div>
              </div>
              <div id="wMRA" class="grid two">
                <span class="NewsGothicECB fs55 switchMRA dis">MRA</span>
                <div>
                  <input
                    type="checkbox"
                    id="switchMRA"
                    onclick="labelChange('switchMRA')"
                    disabled="disabled"
                  /><label for="switchMRA" class="dis">MRA</label>
                </div>
              </div>
            </div>
            <div class="grid two">
              <div id="wARB" class="grid two">
                <span class="NewsGothicECB fs55 switchARB">ARB</span>
                <div>
                  <input
                    type="checkbox"
                    id="switchARB"
                    onclick="labelChange('switchARB')"
                  /><label for="switchARB">ARB</label>
                </div>
              </div>

              <div id="wARNI" class="grid two">
                <span class="NewsGothicECB fs55 switchARNI dis">ARNI</span>
                <div>
                  <input
                    type="checkbox"
                    id="switchARNI"
                    onclick="labelChange('switchARNI')"
                    disabled="disabled"
                  /><label for="switchARNI" class="dis">ARNI</label>
                </div>
              </div>
            </div>
            <div class="grid two">
              <div id="wACEI" class="grid two">
                <span class="NewsGothicECB fs55 switchACEI">ACEI</span>
                <div>
                  <input
                    type="checkbox"
                    id="switchACEI"
                    onclick="labelChange('switchACEI')"
                  /><label for="switchACEI">ACEI</label>
                </div>
              </div>
              <div id="wSGLT21" class="grid two">
                <span class="NewsGothicECB fs55 switchSGLT21 dis">SGLT2I</span>
                <div>
                  <input
                    type="checkbox"
                    id="switchSGLT21"
                    onclick="labelChange('switchSGLT21')"
                    disabled="disabled"
                  /><label for="switchSGLT21" class="dis">SGLT2I</label>
                </div>
              </div>
            </div>
          </div>
          <hr class="mtb25" />
          <div>
            <div class="grid three tweak">
              <div class="grid two tweak">
                <div>
                  <label class="active">Dane Dostępne</label>
                </div>
                <span class="NewsGothicECM fs40">Dane Dostępne</span>
              </div>
              ...
              <div>
                <br> 
                <span onclick="pop()" class="outline NewsGothicECB fs40"
                  >Referencje</span
                >
              </div>
            </div>
            <p class="fs25 NewsGothicECM">
              <strong>INFORMACJA:</strong> Dostępne są dane dotyczące innych leków stosowanych w HFrEF.
               Dane przedstawiono tylko dla leków zalecanych w leczeniu wszystkich pacjentów z HFrEF zgodnie z wytycznymi ESC 2021. <sup>2</sup> <br /><br />
              <sup>†</sup>W porównaniu z kombinacjami tej samej liczby terapii, które nie obejmowały ENTRESTO<sup>&reg;</sup>. 
              Metaanaliza danych z badań RCT opublikowanych od stycznia 1987 r. do stycznia 2020 r. została przeprowadzona przy w oparciu o wstępnie określony protokół badania.
            </p>
          </div>
        </div>
        <div class="colr relative">
          <div class="pbtm">
            ...
            <input
              ...
              value="0"
            />
            <div class="txtcenter NewsGothicECB fs45">
              Względne zmniejszenie ryzyka zgonu z jakiejkolwiek przyczyny śmiertelność vs placebo
            </div>
            ...
            <div id="circleprogAssistant" class="circleprogAssistant">
              ...
              <div id="circleContent" class="NewsGothicECB fs150 yellow">
                ...
                <div class="fs50 yellow" id="bcinfo"></div>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="infopop hide">
      <div class="wrapper inf">
        <div class="bgOpa">
          <div class="pt149">
            <div class="container">
              <span class="close NewsGothicECB" onclick="pop()">X</span>
              <div>
                <span class="fs60 NewsGothicECB"
                  >Rozpoczęcie terapii ENTRESTO<sup>®</sup> u pacjentów z HFrEF<sup>3-5</sup></span
                >
                <div class="ic1">
                  <p class="fs50 NewsGothicECB">
                    <span class="yellow NewsGothicECB">PARADIGM-HF:</span>
                    rozpoczęcie leczenia ambulatoryjnego
                  </p>
                  <p class="fs25 NewsGothicECB">
                    Częstość występowania zdarzeń niepożądanych związanych ze stosowaniem ENTRESTO<sup>®</sup> była porównywalna z enalaprylem w badaniu PARADIGM-HF<sup>2</sup>
                  </p>
                  <ul class="fs25 NewsGothicECB">
                    <li>
                      Objawowa hipotonia występowała częściej w przypadku ENTRESTO<sup >®</sup>niż enalaprylu (14.0% vs 9.2%, p<0.001)<sup>2</sup>
                    </li>
                    <li>
                      Kaszel, stężenie kreatyniny w surowicy &ge;25 ug/mL oraz stężenie potasu w surowicy
                      >6.0 mmol /L występowały rzadziej w przypadku ENTRESTO<sup>®</sup> niż enalaprylu (p<0.05)<sup>2</sup>
                    </li>
                  </ul>
                  <p class="fs25 NewsGothicECB">
                    Mniejsza liczba pacjentów otrzymujących ENTRESTO<sup>®</sup> zaprzestała terapii z powodu działań nieporządaniych w porównaniu do pacjentów przyjmujących enalapryl : 10.7% vs 12.3%, (p=0.03)<sup>2</sup>
                  </p>
                </div>
                <div class="ic2">
                  <p class="fs50 NewsGothicECB">
                    <span class="yellow NewsGothicECB">PIONEER-HF:</span>
                    rozpoczęcie leczenia w szpitalu
                  </p>
                  <p class="fs25 NewsGothicECB">
                    Kluczowe wyniki dotyczące bezpieczeństwa nie różniły się istotnie między grupami ENTRESTO<sup>®</sup> i enalaprylu (do 8 tygodni) po rozpoczęciu leczenia w szpitalu po ustabilizowanym epizodzie ostrej HF <sup>3</sup>
                  </p>
                  <ul class="fs25 NewsGothicECB">
                    <li>
                      Pogorszenie czynności nerek<sup>†</sup> (13.6% vs 14.7% z enalaprylem)
                    </li>
                    <li>
                      Hiperkaliemia<sup>‡</sup> (11.6% vs 9.3% z enalaprylem)
                    </li>
                    <li>
                      Objawowa hipotonia (15.0% vs 12.7% z enalaprylem)
                    </li>
                  </ul>
                  <p class="fs20 NewsGothicECM">
                    UWAGA: Badanie PIONEER-HF obejmowało również pacjentów z niewydolnością serca <em>s de novo</em>.<sup>3</sup>.
                    ENTRESTO<sup>®</sup> jest wskazane w leczeniu przewlekłej niewydolności serca (NYHA II-IV) ze zmniejszoną frakcją wyrzutową lewej komory<sup>1</sup>
                  </p>

                  <p class="fs20 NewsGothicECM">
                    <sup>†</sup>Definiowane jako stężenie kreatyniny w surowicy &ge;44 µmol/L i
                    &ge;25% spadek eGFR.<sup>3</sup><br />
                    <sup>‡</sup>Stężenie potasu w surowicy &ge;5.5
                    mmol/L.<sup>3</sup><br />
                    <strong>PARADIGM-HF:</strong> Randomizowane, podwójnie zaślepione badanie fazy 3 porównujące ENTRESTO<sup>&reg;</sup> do enalaprylu u 8 442 objawowych pacjentów (klasa II-IV wg NYHA) z HFrEF (LVEF &le;40%).
                    Pierwszorzędowy punkt końcowy: zgon z przyczyn sercowo-naczyniowych lub pierwsza hospitalizacja z powodu niewydolności serca.
                    Okres obserwacji: 27 miesięcy (pacjenci leczeni przez okres do 4,3 roku).<sup>2</sup><br />
                    <strong>PIONEER-HF:</strong> Randomizowane, podwójnie zaślepione badanie fazy 3 porównujące wewnątrzszpitalne rozpoczęcie leczenia ENTRESTO<sup>&reg;</sup>z enalaprylem u 881 pacjentów z HFrEF, ustabilizowanych podczas hospitalizacji z powodu ostrej zdekompensowanej HF.
                    Pierwszorzędowy punkt końcowy: uśredniona w czasie proporcjonalna zmiana NT-proBNP od wartości wyjściowej oceniania w tygodniu 4. i 8.<sup>3</sup>
                    <br />
                    <strong>Referencje:</strong> <strong>1.</strong> Tromp J et al. JACC: Heart Fail. 2022; 10(2): 73-84.  <strong>2.</strong>Wytyczne ESC 2021 dotyczące diagnostyki i leczenia ostrej i przewlekłej niewydolności serca <strong>3.</strong> Charakterystyka Produktu Leczniczego Entresto<sup>&reg;</sup><strong> 
                      4.</strong> McMurray JJ et al. N Engl J Med 2014; 371: 993–1004. <strong>5.</strong>. Velazquez EJ et al. N Engl J Med 2019; 380: 539–548.
                  </p>
                </div>
              </div>6            </div>
          </div>
